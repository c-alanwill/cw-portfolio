...
function Footer() {
  ...
  <a className="mx-4" href="https://www.linkedin.com/in/cory-williams-3150b714/">
    <i className="fa-brands fa-linkedin display-6"></i>
  </a>

  <a className="mx-4" href="https://github.com/c-alanwill?tab=repositories">
    <i className="fa-brands fa-github display-6"></i>
  </a>
  
  <a className="mx-4" href="https://twitter.com/altrent123">
